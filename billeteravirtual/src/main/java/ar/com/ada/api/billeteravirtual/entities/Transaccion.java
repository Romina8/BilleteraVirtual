...
public class Transaccion {
    ...
    public enum TipoTransaccionEnum {
        SALIENTE, // El primero siempre es 0
        ENTRANTE // El segundo siempre es 1, y asi sucesivamente...
	}

	public enum ResultadoTransaccionEnum {
        ERROR_IMPORTE_NEGATIVO,
        INICIADA,
		SALDO_INSUFICIENTE, 
		...
		CUENTA_DESTINO_INEXITENTE, 
		SE_QUIERE_PAGAR_A_SI_MISMO, 
		EMAIL_DESTINO_INEXISTENTE
	}
	...
	public enum EstadoTransaccionEnum {
		PENDIENTE(0), ENVIADA(1), RECIBIDA(2), EJECUTADA(4),
		FALTA_FONDOS(80), ERROR_GENERAL(99);
